...
class AzureBlobStorageBuildCacheServiceFactoryTest {
  ...
  void createBuildCacheServiceNpe() {
    AzureBlobStorageBuildCacheServiceFactory serviceFactory =
        new AzureBlobStorageBuildCacheServiceFactory();
    assertThrows(
        NullPointerException.class,
        () ->
            serviceFactory.createBuildCacheService(
                new AzureBlobStorageBuildCache(), testDescriber));
  }
